...
public enum Column implements Columns {
	...
	DISCORD_ID("discordID", CAMPAIGNS, CHARACTERS, CLASSES, OPERATORS, THEMES, PLAYERS, RACES, SESSIONS_DEFAULT),
	
	//AUDITS
	AUDIT_ID("auditID", AUDITS, AUDIT_BANS, AUDIT_BOT_MSG_DEL, AUDIT_COMMANDS, AUDIT_RANK_CHANGES),
	...
	FOREIGN_LOCATION("foreignLocation", CHARACTERS),
	URI("uri", CHARACTERS),
